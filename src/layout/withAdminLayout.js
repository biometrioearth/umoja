        ...
        <LayoutContainer>
          <Layout className="layout">
            <Header
              ...
              className="p-0 flex items-center justify-between bg-warning   h-[72px] z-998"
            >
              <div className="contents flex-row items-center flex-1 h-full">
                <div className=" rtl:ssm:pr-[15px] ltr:pr-5 rtl:pl-5 ltr:ssm:pl-[15px] ltr:ssm:pr-[15px] rtl:ssm::pl:[15px] ltr:pl-[30px] rtl:pr-[30px] xs:ltr:pl-[20px] xs:rtl:pr-[20px] min-w-[280px] ssm:min-w-[220px] xs:min-w-[170px] h-full grid align-middle dark:bg-[#323541]">
                  <div className="flex items-center justify-between">
                    <Link to="/admin">
                      <img
                        className="w-full max-w-[180px] xs:max-w-[500px]"
                        src={require(`../../src/static/img/logos/230517_biometrio_earth_Logo_Landscape_DarkGreen.png`)}
                        alt=""
                      />
                    </Link>
                ...
                <div className="ltr:mr-[10px] rtl:ml-[10px] [&>div:first-child]:flex [&>div]:items-center">
                  <div className="contents flex-row items-center md:hidden justify-end">
                    {topMenu && window.innerWidth > 991 ? (
                      <TopMenuSearch>
          ...
          {window.innerWidth <= 991 ? (
            <span className={collapsed ? 'umoja-shade' : 'umoja-shade show'} onClick={toggleCollapsed} />
          ) : (
            ''
          )}
        </LayoutContainer>
