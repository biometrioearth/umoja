...
const GlobalUtilityStyle = Styled.div`
  ...
  .ant-input:focus {
    border-color: #D2FFAB !important;
    box-shadow: 0 0 0 2px rgb(2 52 4 / 77%) !important;
...
const KnowledgebaseTopWrap = Styled.div`
  ...
  theme[theme.mainContent]['border-color-secondary']};
    ...
    .umoja-knowledgetop__popular--topics{
        margin-top: 22px;
        ul{
            display: flex;
            flex-wrap: wrap;
...
const ProjectHeader = Styled.div`
    ...
    .ant-page-header.umoja-page-header-main{
...
const TaskListStyle = Styled.div`
    .umoja-tassklist-wrap{
        background-color: ${({ theme }) => theme[theme.mainContent]['white-background']};
        border-radius: 10px;
        min-height: 220px;
    }
    .umoja-tasklist-head{
        .umoja-tasklist-head__title{
            font-size: 16px;
            font-weight: 500;
            padding: 15px 30px;
            margin-bottom: 0;
    ...
    .umoja-tasklist-body{
        .umoja-tasklist{
            .umoja-tasklist-item{
                ...
                .umoja-tasklist-item__content{
                    margin-right: 10px;
                }
            }
            .umoja-tasklist-item__title{
                font-size: 16px;
                color: ${({ theme }) => theme[theme.mainContent]['dark-text']};
                .ant-checkbox + span{
                    position: relative;
