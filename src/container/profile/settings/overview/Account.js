                  ...
                  <Row justify="center">
                    <Col xxl={10} lg={16} md={18} xs={24}>
                      <div className="flex items-center flex-wrap justify-between gap-[15px]">
                        <div>
                          <Heading className="text-base  font-semibold text-dark" as="h4">
                            Close Account
                          </Heading>
                        ...
                        <div className="">
                          <Button
                            size="default"
                            type="danger"
                            className="h-[38px] px-4 rounded-full text-sm font-semibold"
                          >
                            Close Account
                          </Button>
                        </div>
                      ...
                      <div className="pt-[48px]">
                        <Button
                          ...
                          htmlType="submit"
                          type="primary"
                          className="h-[44px] px-5 text-sm rounded-full font-semibold"
                        >
                          Save Change
                        </Button>
                        &nbsp; &nbsp;
                        <Button
                          ...
                          type="light"
                          className="h-[44px] px-5 rounded-full text-sm font-semibold bg-transparent dark:text-white87 dark:border-white10 dark:hover:text-primary dark:hover:border-primary"
                        >
                          Cancel
                        </Button>
                      </div>
