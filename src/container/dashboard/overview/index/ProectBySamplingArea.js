  ...
  return (
    <GlobalUtilityStyle>
      <Cards
          ...
          <ul className="flex items-center mb-0">
            <li>
              <Link
                className={
                  locationTab === 'today'
                    ? 'inline-flex items-center bg-warning dark:bg-white10 px-3 h-8 text-primary dark:text-white87 text-13 font-medium rounded-md'
        ...
        title="Projects by Sampling Areas"
        size="large"
        more={moreContent}
