        ...
        <Row gutter={25}>
          ...
          <Col lg={12} xs={24} className="mb-[25px]">
            <div className="bg-white dark:bg-white10 m-0 p-0 text-theme-gray dark:text-white60 text-[15px] rounded-10 relative mb-[25px]">
              ...
              <div className="p-[25px]">
                <Form name="umoja-select" layout="vertical">
            ...
            <div className="bg-white dark:bg-white10 m-0 p-0 text-theme-gray dark:text-white60 text-[15px] rounded-10 relative mb-[25px]">
              ...
              <div className="p-[25px]">
                <Form name="umoja-upload" layout="vertical">
                  <Upload
                    className="umoja-upload-basic [&>.ant-upload-select-text]:border-normal dark:[&>.ant-upload-select-text]:border-white10 [&>.ant-upload-select-text]:border-1 [&>.ant-upload-select-text]:rounded-4 [&>.ant-upload-select-text]:w-full [&>.ant-upload-select-text>.ant-upload]:flex [&>.ant-upload-select-text>.ant-upload]:items-center [&>.ant-upload-select-text>.ant-upload]:justify-between [&>.ant-upload-select-text>.ant-upload>.umoja-upload-text]:text-theme-gray dark:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-text]:text-white60 [&>.ant-upload-select-text>.ant-upload>.umoja-upload-text]:text-[14px] ltr:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-text]:pl-[15px] rtl:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-text]:pr-[15px] [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:border-normal dark:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:border-white10 ltr:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:border-l-1 rtl:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:border-r-1 [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:text-theme-gray dark:[&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:text-white60 [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:inline [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:text-[14px] [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:py-[14px] [&>.ant-upload-select-text>.ant-upload>.umoja-upload-browse]:px-[23px]"
                    {...props}
                  >
                    <span className="umoja-upload-text">Select File</span>
                    <Link to="#" className="umoja-upload-browse">
                      Browse
                    </Link>
                  </Upload>
                </Form>
            ...
            <div className="bg-white dark:bg-white10 m-0 p-0 text-theme-gray dark:text-white60 text-[15px] rounded-10 relative mb-[25px]">
              ...
              <div className="umoja-check-list-wrap p-[25px]">
                <ul className="umoja-check-list umoja-check-list--left">
                  <li>
                ...
                <ul className="umoja-check-list umoja-check-list--right">
                  <li>
                    <Radio>Uncheck</Radio>
                  </li>
                  <li>
